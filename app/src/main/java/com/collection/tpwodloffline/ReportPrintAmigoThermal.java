...
public class ReportPrintAmigoThermal extends AppCompatActivity {
    //AMIGOS
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_report_print_amigo_thermal);
        ...
        try {
            ...
            if (btpObject.isConnected() == true) {
                ...
                if (ReportTyp.equals("D")) {
                    ...
                    btpObject.sendMessage("\n".getBytes());
                    btpObject.sendMessage_HW(CenterAppend1("--------------------", 32), Normal);
                    btpObject.sendMessage_HW(CenterAppend1("DETAIL REPORT ENERGY",32), Normal);

                    btpObject.sendMessage_HW(CenterAppend1("--------------------",32), Normal);
                    btpObject.sendMessage_HW(leftAppend1("DATE:", dateFormat.format(cal.getTime()), 32) , Normal);
                    btpObject.sendMessage_HW(CenterAppend1("--------------------", 32), Normal);
                    ...
                    while (rs.moveToNext()) {
                        btpObject.sendMessage_HW(leftAppend1("COLL MONTH:", rs.getString(1), 32), Normal);
                        btpObject.sendMessage_HW(leftAppend1("TOTAL CONSUMER:", rs.getString(0), 32),Normal);
                        btpObject.sendMessage_HW(CenterAppend1("--------------------",32), Normal);
                    }
                    rs.close();
                    ...
                    rs = DatabaseAccess.database.rawQuery(strUpdateSQL_01, null);
                    btpObject.sendMessage_HW(leftAppend1("CONS_ACC", "  " + "AMT RECVD", 32),Normal);
                    btpObject.sendMessage_HW(leftAppend1("MR_NO", "  " + "RECPT DT", 32),Normal);
                    btpObject.sendMessage_HW(CenterAppend1("--------------------",32), Normal);
                    int iCnt = 0;
                    while (rs.moveToNext()) {
                        btpObject.sendMessage_HW(leftAppend1(rs.getString(0), " " + rs.getString(1), 32),Normal);
                        btpObject.sendMessage_HW(leftAppend1(rs.getString(2), " " + rs.getString(3)+" " + rs.getString(4), 32),Normal);
                        btpObject.sendMessage_HW(CenterAppend1("--------------------",32), Normal);
                    }
                    ...
                    btpObject.sendMessage("\n".getBytes());
                    btpObject.sendMessage_HW(CenterAppend1("--------------------", 32), Normal);
                    btpObject.sendMessage_HW(CenterAppend1("DETAIL REPORT NON-ENERGY",32), Normal);
                    ...
                    btpObject.sendMessage_HW(CenterAppend1("--------------------",32), Normal);
                    btpObject.sendMessage_HW(CenterAppend1("--------------------",32), Normal);
                    btpObject.sendMessage_HW(CenterAppend1("SUMMARY REPORT ENERGY",32), Normal);
                    btpObject.sendMessage_HW(CenterAppend1("--------------------",32), Normal);
                    btpObject.sendMessage_HW(CenterAppend1("--------------------",32), Normal);
                    btpObject.sendMessage_HW(leftAppend1("DATE:", dateFormat.format(cal.getTime()), 32),Normal);
                    btpObject.sendMessage_HW(CenterAppend1("--------------------",32), Normal);
                    ...
                    while (rs.moveToNext()) {
                        btpObject.sendMessage_HW(leftAppend1("COLL MONTH:", rs.getString(1), 32),Normal);
                        btpObject.sendMessage_HW(leftAppend1("TOTAL MR:", rs.getString(0), 32),Normal);
                        btpObject.sendMessage_HW(leftAppend1("TOTAL RECVD:", rs.getString(2), 32),Normal);
                    }
                    rs.close();
                    btpObject.sendMessage_HW(CenterAppend1("--------------------",32), Normal);
                    ...
                    rs = DatabaseAccess.database.rawQuery(strUpdateSQL_01, null);
                    btpObject.sendMessage_HW(leftAppend1("TOT_MR " + "RCPT_DT " + "AMT_RECVD","",32),Normal) ;
                    btpObject.sendMessage_HW(leftAppend1("......" + " " + "........" + " " + ".......","",32),Normal);
                    int iCnt = 0;
                    while (rs.moveToNext()) {
                        btpObject.sendMessage_HW(leftAppend1(rs.getString(0)+ " " + rs.getString(1), " " + rs.getString(2)+" " + rs.getString(3),32),Normal);
                    ...
                    btpObject.sendMessage_HW(CenterAppend1("--------------------",32), Normal);
                    btpObject.sendMessage_HW(CenterAppend1("--------------------",32), Normal);
                    btpObject.sendMessage_HW(CenterAppend1("SUMMARY REPORT NON-ENERGY",32), Normal);
                    btpObject.sendMessage_HW(CenterAppend1("--------------------",32), Normal);
                    btpObject.sendMessage_HW(CenterAppend1("--------------------",32), Normal);
                    btpObject.sendMessage_HW(leftAppend1("DATE:", dateFormat.format(cal.getTime()), 32),Normal);
                    btpObject.sendMessage_HW(CenterAppend1("--------------------",32), Normal);
                    ...
                    btpObject.sendMessage_HW(CenterAppend1("--------------------",32), Normal);
                    btpObject.sendMessage_HW(CenterAppend1("--------------------",32), Normal);
                    btpObject.sendMessage_HW(CenterAppend1("DAILY REPORT ENERGY",32), Normal);
                    ...
                    int iCnt = 0;
                    while (rs.moveToNext()) {
                        btpObject.sendMessage_HW(leftAppend1(widthoff + rs.getString(0), " " + rs.getString(1), 32),Normal);
                        btpObject.sendMessage_HW(leftAppend1(rs.getString(2), " " + rs.getString(3)+" " + rs.getString(4), 32),Normal);
                        btpObject.sendMessage_HW(CenterAppend1("--------------------",32), Normal);
                    ...
                    btpObject.sendMessage_HW(CenterAppend1("--------------------",32), Normal);
                    btpObject.sendMessage_HW(CenterAppend1("--------------------",32), Normal);
                    btpObject.sendMessage_HW(CenterAppend1("DAILY REPORT NON-ENERGY",32), Normal);
                    ...
                    btpObject.sendMessage_HW(CenterAppend1("--------------------",32), Normal);
                    btpObject.sendMessage_HW(CenterAppend1("--------------------",32), Normal);
                    btpObject.sendMessage_HW(CenterAppend1("CONSUMER REPORT",32), Normal);
                    ...
                    btpObject.sendMessage_HW(CenterAppend1("--------------------",32), Normal);
                    btpObject.sendMessage_HW(CenterAppend1("NON RECPT. REPORT",32), Normal);
                    ...
                    rs = DatabaseAccess.database.rawQuery(strUpdateSQL_01, null);
                    //btpObject.sendMessage_HW(CenterAppend1("CUSTOMER ID" + "TRANS.ID" + "AMT",32), Normal);
                    int iCnt = 0;
                    while (rs.moveToNext()) {
                        btpObject.sendMessage_HW(leftAppend1("TRANS.ID:", rs.getString(0), 32),Normal);
                        btpObject.sendMessage_HW(leftAppend1("CUSTOMER ID:", rs.getString(2), 32),Normal);
                        btpObject.sendMessage_HW(leftAppend1("AMOUNT:", rs.getString(1)+" " + rs.getString(3), 32),Normal);
                        //   btpObject.sendMessage_HW(CenterAppend1(leftAppend2(rs.getString(2), rs.getString(0), 7, rs.getString(1), 32),Normal);
                        btpObject.sendMessage_HW(CenterAppend1("--------------------",32), Normal);
