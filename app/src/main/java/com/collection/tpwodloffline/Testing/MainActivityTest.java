...
public class MainActivityTest extends Activity implements Runnable {
        ...
        mScan.setOnClickListener(new View.OnClickListener() {
            public void onClick(View mView) {
                ...
                if (mBluetoothAdapter == null) {
                    Toast.makeText(MainActivityTest.this, "Message1", Toast.LENGTH_SHORT).show();
                } else {
                    if (!mBluetoothAdapter.isEnabled()) {
                        ...
                        ListPairedDevices();
                        Intent connectIntent = new Intent(MainActivityTest.this,
                                DeviceList.class);
        ...
        switch (mRequestCode) {
            ...
            case REQUEST_ENABLE_BT:
                if (mResultCode == Activity.RESULT_OK) {
                    ...
                    Toast.makeText(MainActivityTest.this, "Message", Toast.LENGTH_SHORT).show();
                }
                break;
        }
    }
    ...
    private Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            Toast.makeText(MainActivityTest.this, "DeviceConnected", Toast.LENGTH_SHORT).show();
        }
    };
